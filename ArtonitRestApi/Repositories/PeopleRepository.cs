...
namespace ArtonitRestApi.Repositories
{
    ...
    {
        public static People GetById(string id)
        {
        ...
        public static People GetByCard(string card, int? cardType = -1)
        {
            var userIdentity = ClaimsPrincipal.Current;
            var idPep = userIdentity?.FindFirst(ClaimTypes.NameIdentifier)?.Value;
        ...
        public static int Add(PeopleAdd peopleAdd)
        {
            var userIdentity = ClaimsPrincipal.Current;
        ...
        public static string Update(PeopleAdd peopleAdd, int id)
        {
